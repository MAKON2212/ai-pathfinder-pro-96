...
export const TOOL_DB: Record<string, ToolRec> = {
  ...
  notionai: { name: "Notion AI", category: "Productiviteit", description: "AI in je knowledge base.", useCase: "Auto-samenvattingen, taken genereren, interne docs.", url: "https://notion.so/product/ai", domain: "notion.so", pricing: "€ 10 / gebruiker / mnd", setupTime: "1 week", firstStep: "Bestaande Notion bijwerken naar AI plan en meeting-template aanmaken." },
  ...
  // Development & data
  github: { name: "GitHub Copilot", category: "Ontwikkeling", description: "AI pair programmer voor engineering teams.", useCase: "Software development en code reviews versnellen.", url: "https://github.com/features/copilot", domain: "github.com", pricing: "€ 19 / dev / mnd (Business)", setupTime: "< 1 dag", firstStep: "Org-policy instellen en uitrollen naar 1 squad als pilot." },
