...
export const TOOL_DETAILS: Record<string, ToolDetail> = {
  ...
  github: {
    tagline: "AI pair programmer voor je hele engineering team.",
    useCases: [
...
export const TOOL_DB: Record<string, ToolRec> = {
  ...
  intercom: { name: "Intercom Fin", category: "Customer Support", description: "AI agent die klantvragen direct oplost in chat & email.", useCase: "Tot 70% van support tickets autonoom afhandelen, 24/7.", url: "https://intercom.com/fin", domain: "intercom.com", pricing: "± € 0,90 per opgelost gesprek", setupTime: "1-2 weken", firstStep: "Help center artikelen import + Fin trainen op laatste 100 tickets." },
  ...
  // Content & creative
  midjourney: { name: "Midjourney", category: "Image Generation", description: "State-of-the-art AI beeldgeneratie.", useCase: "Marketing visuals, mockups en brand assets maken.", url: "https://midjourney.com", domain: "midjourney.com", pricing: "vanaf € 10 / mnd", setupTime: "< 1 dag", firstStep: "Brand style-guide vertalen naar 3 prompt-templates." },
  ...
  descript: { name: "Descript", category: "Content Creation", description: "Video & podcast editing op tekst-basis met AI.", useCase: "Webinars en podcasts 5× sneller produceren.", url: "https://descript.com", domain: "descript.com", pricing: "vanaf € 15 / mnd", setupTime: "1 week", firstStep: "Bestaande webinar herbewerken en in 8 social clips knippen." },

  // Development & data
  github: { name: "GitHub Copilot", category: "Development", description: "AI pair programmer voor engineering teams.", useCase: "Software development en code reviews versnellen.", url: "https://github.com/features/copilot", domain: "github.com", pricing: "€ 19 / dev / mnd (Business)", setupTime: "< 1 dag", firstStep: "Org-policy instellen en uitrollen naar 1 squad als pilot." },
  cursor: { name: "Cursor", category: "Development", description: "AI-first code editor met agent-modus.", useCase: "Hele features bouwen door AI op je codebase.", url: "https://cursor.com", domain: "cursor.com", pricing: "€ 20 / dev / mnd", setupTime: "< 1 dag", firstStep: "Senior dev pilot, baseline meten op story-throughput." },
  pinecone: { name: "Pinecone", category: "Infrastructure", description: "Vector database voor AI knowledge retrieval.", useCase: "Interne copilots over je eigen data bouwen.", url: "https://pinecone.io", domain: "pinecone.io", pricing: "vanaf € 0 / serverless usage", setupTime: "2 weken", firstStep: "Knowledge base bron kiezen en eerste 10K docs indexeren." },
